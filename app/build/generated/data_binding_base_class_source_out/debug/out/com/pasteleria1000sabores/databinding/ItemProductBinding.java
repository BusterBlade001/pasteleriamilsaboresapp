...
public final class ItemProductBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView customizableBadge;
  ...
  private ItemProductBinding(@NonNull MaterialCardView rootView,
      @NonNull MaterialButton addToCartButton, @NonNull TextView customizableBadge,
    ...
    this.customizableBadge = customizableBadge;
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.customizable_badge;
      TextView customizableBadge = ViewBindings.findChildViewById(rootView, id);
      if (customizableBadge == null) {
        break missingId;
      }
      ...
      return new ItemProductBinding((MaterialCardView) rootView, addToCartButton, customizableBadge,
